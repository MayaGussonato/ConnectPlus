...
namespace ContatoPlus.Repositories;

public class ContatoRepository : IContatoRepository
{
    private readonly ConnectPlus.WebAPI.BdContextConnect.ConnectPlusContext _context;

    public ContatoRepository(ConnectPlus.WebAPI.BdContextConnect.ConnectPlusContext context)
    {
        _context = context;
    }
    /// <summary>
    ...
    public Contato BuscarPorId(Guid id)
    {
        return _context.Contatos
            .Include(e => e.IdTipoContatoNavigation).FirstOrDefault(e => e.IdContato == id);
